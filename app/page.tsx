  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 flex flex-col">
      ...
      <div className="flex-grow w-full">
        ...
        {loading && <div className="text-black flex items-center flex-col w-full">
          <div className="bg-white p-4 shadow-md justify-center rounded-md text-black md:flex hidden w-full">
    ...
    <span className=" text-black">Loading...</span>
      ...
      {!loading && noResults && <div className="bg-white justify-center p-4 shadow-md rounded-md text-black md:flex hidden w-full"><div className="text-black font-bold flex items-center justify-center flex-col min-h-screen"><span>
        <svg xmlns="http://www.w3.org/2000/svg" height="50" width="50" viewBox="0 0 512 512"><path fill="#ff0000" d="M367.2 412.5L99.5 144.8C77.1 176.1 64 214.5 64 256c0 106 86 192 192 192c41.5 0 79.9-13.1 111.2-35.5zm45.3-45.3C434.9 335.9 448 297.5 448 256c0-106-86-192-192-192c-41.5 0-79.9 13.1-111.2 35.5L412.5 367.2zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z"/></svg>
        </span>No results found</div></div>}
